...
- 🎯 Entry points to execute your program using `python -m <fastapi_sqlmodel_typer>` or `$ fastapi_sqlmodel_typer` with basic CLI argument parsing.
...
---
# fastapi_sqlmodel_typer

[![codecov](https://codecov.io/gh/tzengwei/fastapi-sqlmodel-typer/branch/main/graph/badge.svg?token=fastapi-sqlmodel-typer_token_here)](https://codecov.io/gh/tzengwei/fastapi-sqlmodel-typer)
[![CI](https://github.com/tzengwei/fastapi-sqlmodel-typer/actions/workflows/main.yml/badge.svg)](https://github.com/tzengwei/fastapi-sqlmodel-typer/actions/workflows/main.yml)

Awesome fastapi_sqlmodel_typer created by tzengwei

## Install

from source
```bash
git clone https://github.com/tzengwei/fastapi-sqlmodel-typer fastapi_sqlmodel_typer
cd fastapi_sqlmodel_typer
make install
```
...
```bash
pip install fastapi_sqlmodel_typer
```

## Executing

```bash
$ fastapi_sqlmodel_typer run --port 8080
```

or

```bash
python -m fastapi_sqlmodel_typer run --port 8080
```

or

```bash
$ uvicorn fastapi_sqlmodel_typer:app
```

## CLI

```bash
❯ fastapi_sqlmodel_typer --help
Usage: fastapi_sqlmodel_typer [OPTIONS] COMMAND [ARGS]...
...
```bash
❯ fastapi_sqlmodel_typer create-user --help
Usage: fastapi_sqlmodel_typer create-user [OPTIONS] USERNAME PASSWORD
...
```bash
fastapi_sqlmodel_typer create-user admin admin --superuser
```
...
Run with `fastapi_sqlmodel_typer run` and access http://127.0.0.1:8000/docs

![](https://raw.githubusercontent.com/rochacbruno/fastapi-project-template/master/docs/api.png)


**For some api calls you must authenticate** using the user created with `fastapi_sqlmodel_typer create-user`.
...
-----------------------------------------------------
fastapi_sqlmodel_typer/__init__.py              4      0   100%
fastapi_sqlmodel_typer/app.py                  16      1    94%
fastapi_sqlmodel_typer/cli.py                  21      0   100%
fastapi_sqlmodel_typer/config.py                5      0   100%
fastapi_sqlmodel_typer/db.py                   10      0   100%
fastapi_sqlmodel_typer/models/__init__.py       0      0   100%
fastapi_sqlmodel_typer/models/content.py       47      1    98%
fastapi_sqlmodel_typer/routes/__init__.py      11      0   100%
fastapi_sqlmodel_typer/routes/content.py       52     25    52%
fastapi_sqlmodel_typer/routes/security.py      15      1    93%
fastapi_sqlmodel_typer/routes/user.py          52     26    50%
fastapi_sqlmodel_typer/security.py            103     12    88%
-----------------------------------------------------
TOTAL                               336     66    80%
...
> `dynaconf_merge` is a boolean that tells if the settings should be merged with the default settings defined in fastapi_sqlmodel_typer/default.toml.
