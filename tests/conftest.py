...
# WARNING: Ensure imports from `fastapi_sqlmodel_typer` comes after this line
from fastapi_sqlmodel_typer import app, settings, db  # noqa
from fastapi_sqlmodel_typer.cli import create_user, cli  # noqa
